package com.patientassistant.home.security.filter;


import com.patientassistant.home.security.config.SecurityUserDetailsService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        return request.getServletPath().endsWith("auth/login") ||
                ...
                request.getServletPath().endsWith("/auth/register/doctor");
    }
}
